...
PACK(typedef struct _Partition
{
...
PACK(typedef struct _MBR
{
    uint8_t code[446];
    _Partition partitions[4];
    uint16_t signature; 
} _MBR);

PACK(typedef struct _FBoot
{
    uint8_t jump[3];
